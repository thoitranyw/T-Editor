/**
 * toRgbString(): rgba(255, 255, 255)
 * toRgbaString(): rgba(255, 255, 255, 1)
 * toHwbString(): hwb(0, 100%, 0%)
 * toHwbStringDecimal(): hwb(0, 1, 0)
 * toHwbaString(): hwba(0, 100%, 0%, 1)
 * toHslString(): hsl(0, 0%, 100%)
 * toHslStringDecimal(): hsl(0, 0, 1)
 * toHslaString(): hsla(0, 0%, 100%, 1)
 * toCmykString(): cmyk(0%, 0%, 0%, 0%)
 * toCmykStringDecimal(): cmyk(0, 0, 0, 0)
 * toNcolString(): R0, 100%, 0%
 * toNcolStringDecimal(): R0, 1, 0
 * toNcolaString(): R0, 100%, 0%, 1
 * toName(): White
 * toHexString(): #ffffff
 * toRgb(): {a, b, g, r}
 * toHsl(): {a, h, l, s}
